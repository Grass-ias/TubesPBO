...
public class MainEPK {
    ...
    public static void main(String[] args) {
        ...
        // Skenario A: Divisi Acara mengeksekusi task1 (kesulitan 3). Panitia comm1 berkapasitas 5. Harus sukses.
        try {
            System.out.println("Mengeksekusi Tugas: " + task1.getTaskName() + " (Kesulitan: " + task1.getDifficulty() + ") via " + acaraDiv.getDivisionName());
        ...
        // Skenario B: Divisi Logistik mengeksekusi task2 (biaya 3,500,000). Anggaran 4,000,000. Harus sukses.
        try {
            System.out.println("Mengeksekusi Tugas: " + task2.getTaskName() + " (Biaya: " + task2.getTaskCost() + ") via " + logisticDiv.getDivisionName());
        ...
        // Skenario C: Kesalahan Anggaran Lebih (OverBudgetException) pada Divisi Logistik.
        // Mencoba mengeksekusi task4 (biaya 5,000,000) pada sisa anggaran (500,000). Harus memicu OverBudgetException.
        try {
            System.out.println("Mengeksekusi Tugas: " + task4.getTaskName() + " (Biaya: " + task4.getTaskCost() + ") via " + logisticDiv.getDivisionName());
        ...
        // Skenario D: Kesalahan Kapasitas Kerja Berlebih (OverloadException) pada Divisi Konsumsi.
        // Mencoba mengeksekusi task3 (kesulitan 4) dengan panitia comm3 (kapasitas 2). Harus memicu OverloadException.
        try {
            System.out.println("Mengeksekusi Tugas: " + task3.getTaskName() + " (Kesulitan: " + task3.getDifficulty() + ") via " + konsumsiDiv.getDivisionName());
        ...
        // Skenario E: Divisi Acara mencoba mengeksekusi tugas baru yang melebihi sisa kapasitas panitia comm1.
        // Beban kerja comm1 saat ini adalah 3. Maksimum adalah 5. Mencoba menambahkan taskE dengan kesulitan 3. Harus memicu OverloadException.
        Task taskE = new Task("T05", "Koordinasi Pemateri Luar", 3, 0.0);
        try {
            System.out.println("Mengeksekusi Tugas: " + taskE.getTaskName() + " (Kesulitan: " + taskE.getDifficulty() + ") via " + acaraDiv.getDivisionName());
